...
### User 2 ###
Transaction.create!(user: louis_xtrem, amount: 250, due_date: "14/02/2021", status: "paid", comment: "Diner aux chandelles", bank_account: bank_account_louis_xtrem)
...
Transaction.create!(user: louis_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_louis_xtrem)
### User 3 ###
Transaction.create!(user: pierre_xtrem, amount: 640, due_date: "15/02/2021", status: "paid", comment: "Rentrée des classes", bank_account: bank_account_pierre_xtrem)
...
Transaction.create!(user: pierre_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_pierre_xtrem)
### User 4 ###
...
Transaction.create!(user: max_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_max_xtrem)
### User 5 ###
Transaction.create!(user: paul_xtrem, amount: 70, due_date: "14/02/2021", status: "paid", comment: "Diner aux chandelles", bank_account: bank_account_paul_xtrem)
...
Transaction.create!(user: paul_xtrem, amount: 50, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_paul_xtrem)
### User 6 ###
Transaction.create!(user: jack_xtrem, amount: 90, due_date: "14/02/2021", status: "paid", comment: "Diner aux chandelles", bank_account: bank_account_jack_xtrem)
...
Transaction.create!(user: jack_xtrem, amount: 65, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_jack_xtrem)
### User 7 ###
Transaction.create!(user: saul_xtrem, amount: 40, due_date: "14/02/2021", status: "paid", comment: "Diner aux chandelles", bank_account: bank_account_saul_xtrem)
...
Transaction.create!(user: saul_xtrem, amount: 40, due_date: "28/12/2020", transfer_date: "28/12/2020", status: "paid", comment: "Abonnement sportif", bank_account: bank_account_saul_xtrem)
Transaction.create!(user: saul_xtrem, amount: 100, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_saul_xtrem)
### User 8 ###
Transaction.create!(user: john_xtrem, amount: 65, due_date: "14/02/2021", status: "paid", comment: "Diner aux chandelles", bank_account: bank_account_john_xtrem)
Transaction.create!(user: john_xtrem, amount: 165, due_date: "06/01/2021", transfer_date: "16/01/2020", status: "paid", comment: "Courses", bank_account: bank_account_john_xtrem)
Transaction.create!(user: john_xtrem, amount: 35, due_date: "28/12/2020", transfer_date: "28/12/2020", status: "paid", comment: "Abonnement sportif", bank_account: bank_account_john_xtrem)
Transaction.create!(user: john_xtrem, amount: 115, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_john_xtrem)
### User 9 ###
...
Transaction.create!(user: alphonse_xtrem, amount: 420, due_date: "28/12/2020", transfer_date: "28/12/2020", status: "paid", comment: "Abonnement sportif", bank_account: bank_account_alphonse_xtrem)
Transaction.create!(user: alphonse_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_alphonse_xtrem)
### User 10 ###
...
Transaction.create!(user: robin_xtrem, amount: 200, due_date: "06/01/2021", transfer_date: "16/01/2020", status: "paid", comment: "Courses", bank_account: bank_account_robin_xtrem)
Transaction.create!(user: robin_xtrem, amount: 420, due_date: "28/12/2020", transfer_date: "28/12/2020", status: "paid", comment: "Abonnement sportif", bank_account: bank_account_robin_xtrem)
Transaction.create!(user: robin_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_robin_xtrem)
### User 11 ###
...
Transaction.create!(user: philippe_xtrem, amount: 200, due_date: "06/01/2021", transfer_date: "16/01/2020", status: "paid", comment: "Courses", bank_account: bank_account_philippe_xtrem)
Transaction.create!(user: philippe_xtrem, amount: 420, due_date: "28/12/2020", transfer_date: "28/12/2020", status: "paid", comment: "Abonnement sportif", bank_account: bank_account_philippe_xtrem)
Transaction.create!(user: philippe_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_philippe_xtrem)
### User 12 ###
...
Transaction.create!(user: marie_xtrem, amount: 200, due_date: "06/01/2021", transfer_date: "16/01/2020", status: "paid", comment: "Courses", bank_account: bank_account_marie_xtrem)
Transaction.create!(user: marie_xtrem, amount: 420, due_date: "28/12/2020", transfer_date: "28/12/2020", status: "paid", comment: "Abonnement sportif", bank_account: bank_account_marie_xtrem)
Transaction.create!(user: marie_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_marie_xtrem)
### User 13 ###
Transaction.create!(user: maria_xtrem, amount: 250, due_date: "14/02/2021", status: "paid", comment: "Diner aux chandelles", bank_account: bank_account_maria_xtrem)
...
Transaction.create!(user: maria_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_maria_xtrem)
### User 14 ###
...
Transaction.create!(user: alexandra_xtrem, amount: 420, due_date: "28/12/2020", transfer_date: "28/12/2020", status: "paid", comment: "Abonnement sportif", bank_account: bank_account_alexandra_xtrem)
Transaction.create!(user: alexandra_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_alexandra_xtrem)
### User 15 ###
...
Transaction.create!(user: ismael_xtrem, amount: 420, due_date: "28/12/2020", transfer_date: "28/12/2020", status: "paid", comment: "Abonnement sportif", bank_account: bank_account_ismael_xtrem)
Transaction.create!(user: ismael_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_ismael_xtrem)
### User 16 ###
...
Transaction.create!(user: rachida_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_rachida_xtrem)
### User 17 ###
...
Transaction.create!(user: fatima_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_fatima_xtrem)
### User 18 ###
...
Transaction.create!(user: sandra_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_sandra_xtrem)
### User 19 ###
...
Transaction.create!(user: carlos_xtrem, amount: 130, due_date: "15/10/2020", transfer_date: "15/12/2020", status: "paid", comment: "Ecran Telephone", bank_account: bank_account_carlos_xtrem)
### User 20 ###
...
Transaction.create!(user: fiona_xtrem, amount: 200, due_date: "06/01/2021", transfer_date: "16/01/2020", status: "paid", comment: "Courses", bank_account: bank_account_fiona_xtrem)
Transaction.create!(user: fiona_xtrem, amount: 420, due_date: "28/12/2020", transfer_date: "28/12/2020", status: "paid", comment: "Abonnement sportif", bank_account: bank_account_fiona_xtrem)
