...
article1 = Article.new(title: "L'épargne salariale", category: "Epargne", date: "12/01/2021", content: "Les sommes distribuées aux salariés peuvent être placées à votre guise en épargne salariale.")
...
article2 = Article.new(title: "Dialogue vs la Covid", category: "RH", date: "15/01/2021", content: "Si la crise a eu un impact positif, c’est en mettant en avant le dialogue social en entreprises.")
article2.photo.attach(io: photo2, filename: 'epargne.png', content_type: 'image/png')
article2.save!
#article 3
...
article3 = Article.new(title: "Acompte: vos droits", category: "Droit", date: "21/01/2021", content: "L’acompte correspond au versement anticipé d’une partie du salaire du mois en cours.")
article3.photo.attach(io: photo3, filename: 'epargne.png', content_type: 'image/png')
article3.save!
#article 4
...
article4 = Article.new(title: "Crédit consommation", category: "Frais bancaires", date: "27/01/2021", content: "Une alternative inadaptée aux attentes des français. N'attendez plus et choisissez Popay.")
article4.photo.attach(io: photo4, filename: 'epargne.png', content_type: 'image/png')
article4.save!
#article 5
...
article5 = Article.new(title: "Popay vous conseille", category: "Epargne", date: "08/02/2021", content: "Fini les agios, reprenez le contrôle de vos finances en choisissant Popay dès aujourd'hui.")
article5.photo.attach(io: photo5, filename: 'epargne.png', content_type: 'image/png')
article5.save!